...
const VideoPlayer = () => {
  ...
  useEffect(() => {
    ...
    console.log(
      "Player initialization effect running for lecture:",
      lecture.id
    );
    ...
    const attemptInitialization = () => {
      ...
      if (!videoRef.current) {
        console.log(
          "Video container no longer exists, aborting initialization"
        );
        return;
      }
      ...
      if (videoElement) {
        ...
        const startPosition = lecture.completed
          ? 0
                      ...
                      onClick={() => {
                        ...
                        if (playerRef.current) {
                          try {
                            ...
                            console.log(
                              "Successfully reset video to beginning"
                            );
                          } catch (error) {
